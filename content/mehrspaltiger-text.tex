...
%---
\begin{multicols}{2}[\section{Goethe – Werther}]%für mehrspaltigen Text, in 2. Anzahl der SPalten; damit für TEX deutlich, dass section zum mehrsp. Text
...
%---
\section{Griechisch-Deutsch mit highly educated fashionable paket}
\begin{pairs}
\begin{Leftside}
\beginnumbering
...
%\Columns%wenn auf einer Seite als Spalten
\Pages%so auf unterschiedlichen Seiten!!
